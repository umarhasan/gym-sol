        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <div class="card-body d-flex align-items-end justify-content-between">
                  <div class="dropdown mb-3 ml-auto">
                    <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" id="filterDropdown">
                      @if ($filterBy == 'weekly') Current Week
                      @elseif($filterBy == 'daily') Today
                      @elseif($filterBy == 'monthly') Current Month
                      @else Date Range
                      @endif
                    </button>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <span style="text-align: center; font-weight: bold; font-family: Arial, sans-serif;color:#000;margin: 0px 0px -35px 447px;">Total Expenses: {{ $totalExpense }}</span>

                <table id="expense-history" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                  <thead>
                    <tr>
                      <th>Expense by</th>
                      <th>Paid To</th>
