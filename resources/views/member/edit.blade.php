          ...
          <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="text-center">
                    ...
                    @else
                        <img src="{{ asset('admin/images/logo/profile.jpg') }}" alt="Default Profile Image" class="rounded-circle" style="width: 200px; height: 200px;">
                    @endif
                </div>
              </div>
            <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <form method="post" class="" action="{{ route('member.update', $user->id) }}" enctype="multipart/form-data"> <!-- Change the route to update -->
                        @csrf
...
<input class="form-control" type="date" name="expiry" placeholder="MM/DD/YYYY" value="{{ isset($user->Fees) && $user->Fees->expiry ? \Carbon\Carbon::parse($user->Fees->expiry)->format('Y-m-d') : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
